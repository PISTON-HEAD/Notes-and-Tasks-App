...
7. In both notes and tasks, the date and  time of the last edit done is updated and displayed which is very unqiue to this app.
...
9. This app doesnt take any space from your device for saving data of your notes and tasks. It is saved in real time in the app's cloud storage base.
10. Signup is made easy and user friendly. Signup with app and a google signup option is also provided. Forgot password option is also provided wgich sends the user a mail with the link to reset your password, so your password is completely secure. 
